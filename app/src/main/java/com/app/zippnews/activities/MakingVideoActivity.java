...
import com.app.zippnews.adapters.VideoEffectsAdapter;
import com.app.zippnews.adapters.VideoFilteroverlaysAdapter;
import com.app.zippnews.model.EffectsModel;
import com.app.zippnews.model.FiltersModel;
import com.app.zippnews.utils.Effects;
import com.app.zippnews.utils.FilterOverlays;
import com.app.zippnews.utils.SampleGLView;
...
public class MakingVideoActivity extends AppCompatActivity implements View.OnClickListener, VideoEffectsAdapter.onEffectClickListener,VideoFilteroverlaysAdapter.onFilterClickListener{
    ...
    private void init()
    {
        deleteTempFiles(getResources());
        if(getTempVideosDir(getResources()).exists())
            getTempVideosDir(getResources()).delete();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            ...
            case R.id.iv_record:
                if (isRecordStart) {
                   if(getTempVideosDir(getResources()).exists() && getTempVideosDir(getResources()).listFiles().length>0)
                   {
                     if(filepath!=null)
                         goToSinglePlayActivity();
                   }
                   else {
                       filepath = getVideoFilePath(getResources());
                    ...
                    layout_bottomicons.setVisibility(View.GONE);
    ...
    public static String getVideoFilePath(Resources resources) {
        String file_path = Environment.getExternalStorageDirectory().getAbsolutePath() +
                "/"+resources.getString(R.string.app_name)+"tempvideos";
    ...
    public static File getTempVideosDir(Resources resources)
    {
        String file_path = Environment.getExternalStorageDirectory().getAbsolutePath() +
                "/"+resources.getString(R.string.app_name)+"tempvideos";
        File dir = new File(file_path);
    ...
    public static void deleteTempFiles(Resources resources)
    {
        if(getTempVideosDir(resources).exists())
        {
            File dir=getTempVideosDir(resources);
