...
public class EditProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadProfilepic(String picpath){
        ...
        Call<ProfilepicUpdateResponse> call= RetrofitApis.Factory.create(EditProfileActivity.this).uploadProfilepic(sessionManagement.getValueFromPreference(SessionManagement.USER_TOKEN),fileToUpload,userid);
    ...
    private void profileUpdate(String userid,String fullname,String biodata){
        ...
        Log.e("x_api_key",sessionManagement.getValueFromPreference(SessionManagement.USER_TOKEN));
        Utils.showDialog(EditProfileActivity.this);
        Call<ProfilepicUpdateResponse> call= RetrofitApis.Factory.create(EditProfileActivity.this).profileUpdate(sessionManagement.getValueFromPreference(SessionManagement.USER_TOKEN),userid,fullname,biodata);
        call.enqueue(new Callback<ProfilepicUpdateResponse>() {
            @Override
            public void onResponse(Call<ProfilepicUpdateResponse> call, Response<ProfilepicUpdateResponse> response) {
                Utils.dismissDialog();
